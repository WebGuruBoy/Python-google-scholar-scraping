...
class Configuration:
    ...
    def __init__(self, f):
        ...
        self.default_photo = self.get_default_photo()
    ...
    def get_default_photo(self):
        return self.__config['default_photo'] if 'default_photo' in self.__config else \
            str(Path.home()) + "\\Downloads\\crosscholar\\avatar_scholar_56.png"
